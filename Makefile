...
evaluate : install
	@cd student && uv run python -m $(SRC_UV) evaluate --student_answer_path ../data/output/search_results/dataset_docs_public.json --dataset_path ../data/datasets/public/AnsweredQuestions/dataset_docs_public.json --k 10 --max_context_length 2000
